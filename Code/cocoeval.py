...
# Source : https://github.com/tylin/coco-caption
...
def test_cocoscorer():
    ...
    gts = {
        'Fe4tO5vW9_E_64_70':[
        {u'image_id': 'Fe4tO5vW9_E_64_70', u'cap_id': 0, u'caption': u'A train traveling down tracks next to lights.',
         'tokenized': 'a train traveling down tracks next to lights'},
        {u'image_id': 'Fe4tO5vW9_E_64_70', u'cap_id': 1, u'caption': u'A train coming down the tracks arriving at a station.',
         'tokenized': 'a train coming down the tracks arriving at a station'}],
        '_0nX-El-ySo_83_93': [
        {u'image_id': '_0nX-El-ySo_83_93', u'cap_id': 0, u'caption': u'A large jetliner flying over a traffic filled street.',
         'tokenized': 'a large jetliner flying over a traffic filled street'},
        {u'image_id': '_0nX-El-ySo_83_93', u'cap_id': 1, u'caption': u'The plane is flying over top of the cars',
         'tokenized': 'the plan is flying over top of the cars'},]
        }
        
    samples = {
        'Fe4tO5vW9_E_64_70': [{u'image_id': 'Fe4tO5vW9_E_64_70', u'caption': u'train traveling down a track in front of a road'}],
        '_0nX-El-ySo_83_93': [{u'image_id': '_0nX-El-ySo_83_93', u'caption': u'plane is flying through the sky'}],
        }
    IDs = ['Fe4tO5vW9_E_64_70', '_0nX-El-ySo_83_93']
    scorer = COCOScorer()
